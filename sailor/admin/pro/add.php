<?php 
    if(isset($_POST['btn'])){
        $data = $_POST['frm'];
        $folder="project-".rand();
        $img = uploder('img',"assets/images/projects/",$folder,"projects");
        addpro($data,$img);
    }
?>
                            <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">افزودن پروژه جدید</h4>

                                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">عنوان پروژه*</label>
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[title]" placeholder="عنوان پروژه را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="form-group">
	                                       <label class="col-md-2 control-label">  توضیحات مربوط به پروژه*</label>
	                                       <div class="col-md-7">
