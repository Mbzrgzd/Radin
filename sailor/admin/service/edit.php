<?php
    $id=$_GET['id'];
    $result = showEditservice($id);


    if(isset($_POST['btn'])){
        $data = $_POST['frm'];
        $oldpic=$result['img'];
        editservice($data,$id,'img',$oldpic);
...
?>
                           <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">ویرایش خدمات</h4>
                                    ...
                                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">فونت اویس*</label>
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[fontaweson]" value="<?php echo $result['fontaweson']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
