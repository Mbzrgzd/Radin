<?php 
    if(isset($_POST['btn'])){
        $data = $_POST['frm'];
        $folder="service-".rand();
        $img = uploder('img',"assets/images/services/",$folder,"services");
        addservice($data,$img);
    }
?>
                            <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">افزودن خدمات جدید</h4>
                                    ...
                                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[fontaweson]" placeholder="راهنمایی">
                                            </div>
                                        </div>
                                        <div class="form-group">
