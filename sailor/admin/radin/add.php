<?php 
    if(isset($_POST['btn'])){
        $data = $_POST['frm'];
        $folder="radin-".rand();
        $img = uploder('img',"assets/images/radin/",$folder,"radin");
        addradin($data,$img);
    }
?>
                            <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">افزودن عضو جدید</h4>

                                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label"> سمت*</label>
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[title]" placeholder="سمت عضو جدید را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[name]" placeholder="نام و نام خانوادگی را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="form-group">
	                                       <label class="col-md-2 control-label">رزومه واطلاعات تماس*</label>
	                                       <div class="col-md-7">
	                                           <textarea class="form-control" rows="5" name="frm[text]"></textarea>
	                                       </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-sm-2 control-label">تصویر عضو جدید*</label>
                                            <div class="col-sm-7">
                                                <div class="card-box">
