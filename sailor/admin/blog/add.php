<?php 
    if(isset($_POST['btn'])){
        $data = $_POST['frm'];
        $folder="blog-".rand();
        $img = uploder('img',"assets/images/blog/",$folder,"blog");
        addblog($data,$img);
    }
?>
                            <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">افزودن مقاله (متون تخصصی) جدید</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[title]" placeholder="عنوان مقاله یا متن تخصصی را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="form-group">
