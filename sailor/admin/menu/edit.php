...
?>
                            <div class="col-lg-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0  m-b-30">ویرایش منو <?php echo $result['title']; ?></h4>
                                    ...
                                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post">
                                        ...
                                        <div class="form-group"> 
                                            <label for="webSite" class="col-sm-2 control-label">لینک سایت*</label>
                                            <div class="col-sm-7">
                                                <input type="url" required parsley-type="url" class="form-control" id="webSite" name="frm[url]" placeholder="لینک منو را وارد کنید" value="<?php echo $result['url']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
