                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" required parsley-type="email" class="form-control"
                                                       id="inputEmail3" name="frm[title]" placeholder="عنوان منو را وارد کنید">
                                            </div>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="webSite" class="col-sm-2 control-label">لینک سایت*</label>
                                            <div class="col-sm-7">
                                                <input type="url" required parsley-type="url" class="form-control" id="webSite" name="frm[url]" placeholder="لینک منو را وارد کنید">
                                            </div>
                                        </div>
